/**
 * @file CGAudioCompressor.js
 * @author
 * @date 2021/12/8
 * @brief CGAudioCompressor.js
...
class CGAudioCompressor extends BaseNode {
    constructor() {
        super();
        this.audioNode = null;
    ...
    initAudio(sys) {
        if (this.audioGraph) {
            ...
            this.audioNode.addSearchPath(sys.scene.assetMgr.rootDir + "audio/AudioCompressor")
            this.audioNode.setupMDSPGraphFromFile(sys.scene.assetMgr.rootDir + "audio/AudioCompressor/config.json")
        }
    }
};

exports.CGAudioCompressor = CGAudioCompressor;
