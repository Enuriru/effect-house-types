/**
 * @file CGAudioDistortion.js
 * @author
 * @date 2021/12/8
 * @brief CGAudioDistortion.js
...
class CGAudioDistortion extends BaseNode {
 constructor() {
  super();
  this.audioNode = null;
 ...
 initAudio(sys) {
  if (this.audioGraph) {
   ...
   this.audioNode.addSearchPath(sys.scene.assetMgr.rootDir + "audio/AudioDistortion")
   this.audioNode.setupMDSPGraphFromFile(sys.scene.assetMgr.rootDir + "audio/AudioDistortion/config.json")
  }
 }
};

exports.CGAudioDistortion = CGAudioDistortion;
