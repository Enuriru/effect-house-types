...
class CGAudioEcho extends BaseNode {
 constructor() {
  super();
  this.audioNode = null;
 ...
 initAudio(sys) {
  if (this.audioGraph) {
   ...
   this.audioNode.addSearchPath(sys.scene.assetMgr.rootDir + "audio/AudioEcho")
   this.audioNode.setupMDSPGraphFromFile(sys.scene.assetMgr.rootDir + "audio/AudioEcho/config.json")
  }
 }
};

exports.CGAudioEcho = CGAudioEcho;
