/**
 * @file CGAudioEffectMegaphone.js
 * @author
 * @date 2021/12/31
 * @brief CGAudioEffectMegaphone.js
...
class CGAudioEffectMegaphone extends BaseNode {
  constructor() {
    super();
    this.audioNode = null;
    this.audioNodeName = 'megaphone';
...
exports.CGAudioEffectMegaphone = CGAudioEffectMegaphone;
