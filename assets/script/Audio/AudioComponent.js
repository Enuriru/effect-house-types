...
class AudioComponent {
    ...
    updateProperties() {
        ...
        if (this.volume !== this.audioVolume) {
            ...
            this.audioGainNode.gain = this.volume / 100.0;
        }
        ...
        if (this.isAutoPlay !== this.autoPlay || this.audioPlayMode !== this.playMode || this.loopCount !== this.loopAmount) {
    ...
    resetToPlay() {
        this.currentLoop = 0;
        this.timer = 0;
        if (this.enabled === true && this.getNativeComponent().entity && this.getNativeComponent().entity.visible === true) {
            this.play();
        }
    }
    ...
    onUpdate(dt) {
        if (this.getNativeComponent().entity && this.getNativeComponent().entity.visible === false && this.prevEntityVisibleState === true) {
            this.stopAndReset();
            this.prevEntityVisibleState = false;
            this.enabled = false
            return;
        }
        if (this.getNativeComponent().entity && this.getNativeComponent().entity.visible === true && this.prevEntityVisibleState === false) {
            this.resetToPlay();
            this.prevEntityVisibleState = true;
            this.enabled = true;
        }
